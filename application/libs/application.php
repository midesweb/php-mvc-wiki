...
class Application
{
    ...
    private function splitUrl()
    {
        if (isset($_GET['url'])) {
            ...
            //debug en un archivo de log, para ver las redirecciones que van ocurriendo
            fwrite(Log::$ar, "\r\nSOLICITUD NUEVA\r\n");
            fwrite(Log::$ar, date('l jS \of F Y h:i:s A') . "\r\n");
            fwrite(Log::$ar, 'Controller: ' . $this->url_controller . "\r\n");
            fwrite(Log::$ar, 'Action: ' . $this->url_action . "\r\n");
            fwrite(Log::$ar, 'Parameter 1: ' . $this->url_parameter_1 . "\r\n");
              
            //guardo la acción sobre Application como variable estatica para saber que acción estoy haciendo
            self::$infoAction = $this->url_action;
        }
    }
}
