...
class Controller
{
    ...
    {
        //compruebo si tiene la cookie para recordar este usuario
        if (!isset($_SESSION['usuario_logueado']) && isset($_COOKIE['rememberme']) && Application::$infoAction != "loginWithCookie") {
            Log::escribeArchivo("Hago el header para ir a loginWithCookie / accion: " . Application::$infoAction );
